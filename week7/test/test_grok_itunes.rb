...
class TestGrokITunes < Test::Unit::TestCase
  ...
  def test_z_top_tracks_on_rating_times_playcount
    actual = @grok.top_tracks_on_rating_times_playcount
    expected = [
      ["8000", "Carnage Visors", "The Cure", "Wed Sep 17 12:10:59 -0700 2008"],
      ["6640", "Future Proof", "Massive Attack", "Thu Oct 02 05:57:15 -0700 2008"],
      ["6500", "Group Four", "Massive Attack", "Wed Sep 17 18:54:47 -0700 2008"],
      ["6400", "Teardrop", "Massive Attack", "Thu Oct 23 05:57:05 -0700 2008"],
      ["6000", "Angel", "Massive Attack", "Tue Oct 07 12:51:24 -0700 2008"],
      ["5800", "Special Cases", "Massive Attack", "Mon Oct 06 17:01:13 -0700 2008"],
      ["5600", "Inertia Creeps", "Massive Attack", "Thu Oct 23 07:16:22 -0700 2008"],
      ["5500", "Dissolved Girl", "Massive Attack", "Mon Oct 06 16:15:23 -0700 2008"],
      ["5300", "No New Tale To Tell", "Love &#38; Rockets", "Mon Nov 03 01:48:38 -0800 2008"],
      ["5100", "Risingson", "Massive Attack", "Sat Oct 18 08:53:14 -0700 2008"]
    ]
    assert_equal expected, actual
  end
  
  def test_z_oldest_tracks
    actual = @grok.oldest_tracks
    expected = [
			["Thu Aug 15 18:14:03 -0700 2002", "Introduction"],
			["Thu Nov 13 19:26:53 -0800 2003", "Segue: Ramona A. Stone/I Am With Name"],	
			["Tue Dec 23 08:02:11 -0800 2003", "Mother / Oh Mein Pa Pa"],
			["Tue Dec 23 08:59:40 -0800 2003", "Shame"],
			["Fri Feb 27 18:45:22 -0800 2004", "Fourteen"],
			["Mon Mar 22 04:31:04 -0800 2004", "To Have And To Hold"],
			["Tue Apr 20 06:52:50 -0700 2004", "Over And Out"],
			["Thu May 06 03:23:40 -0700 2004", "The Theft"],
			["Tue Jun 08 10:32:05 -0700 2004", "Sins Of The Fathers"],
			["Fri Jul 02 23:01:19 -0700 2004", "Back On Earth"]
    ]
    assert_equal expected, actual
  end
  
  def test_z_top_tracks_aging_well
		@grok.now = Time.parse("Tue Dec 09 18:00:00 -0800 2008")
    actual = @grok.top_tracks_aging_well
    expected = [
      [35350,"Carnage Visors","The Cure","Wed Sep 17 12:10:59 -0700 2008"],
      [28722,"Group Four","Massive Attack","Wed Sep 17 18:54:47 -0700 2008"],
      [28017,"Future Proof","Massive Attack","Thu Oct 02 05:57:15 -0700 2008"],
      [24858,"Angel","Massive Attack","Tue Oct 07 12:51:24 -0700 2008"],
      [24640,"Teardrop","Massive Attack","Thu Oct 23 05:57:05 -0700 2008"],
      [24121,"Special Cases","Massive Attack","Mon Oct 06 17:01:13 -0700 2008"],
      [22873,"Dissolved Girl","Massive Attack","Mon Oct 06 16:15:23 -0700 2008"],
      [21560,"Inertia Creeps","Massive Attack","Thu Oct 23 07:16:22 -0700 2008"],
      [20794,"One Hundred Years","The Cure","Mon Oct 06 10:56:13 -0700 2008"],
      [20715,"A Prayer For England","Massive Attack","Tue Oct 07 15:00:18 -0700 2008"]
    ]
    assert_equal expected, actual
  end

# This test *ALWAYS* passes regardless of data matching or not
# Something is weird with scrobbler me thinks
#
#  def test_z_you_may_like_massive_attack
#    actual = @grok.you_may_like("Massive Attack")
#    expected = [
#      [ "100", "Tricky"],
#      [ "88.11", "Portishead"],
#      [ "86.29", "Lamb"],
